...
const timelineDotVariants = cva(
  "col-start-2 col-end-3 row-start-1 row-end-1 flex size-4 items-center justify-center rounded-full border border-green-300",
  {
    variants: {
      status: {
        default: "[&>*]:hidden",
        ...
        done: "bg-green-300 [&>*:not(.lucide-check)]:hidden [&>.lucide-check]:text-background",
        error:
    ...
    return (
      <hr
        ...
        className={cn(
          ...
          done ? "bg-primary" : "dark:bg-slate-500 bg-slate-300",
          className
        )}
        ref={ref}
        {...props}
